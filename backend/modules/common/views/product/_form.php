...
$this->context->addBreadCrumb('Список товаров', ['/management/common/product/index']);
$this->context->addBreadCrumb($this->title);

\backend\modules\management\modules\common\assets\ProductAsset::register($this);
?>
    ...
    <div class="row">
        ...
        <div class="col-md-5 col-md-offset-1">
            ...
            <?= Html::button('Добавить цену', [
                'data-url'   => Url::to('/management/common/product/add-price'),
