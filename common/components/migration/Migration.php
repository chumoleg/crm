...
class Migration extends \yii\db\Migration
{
    ...
    const PRIMARY_KEY = 'INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY';
    const INT_FIELD = 'INT UNSIGNED DEFAULT NULL';
    const INT_FIELD_NOT_NULL = 'INT UNSIGNED NOT NULL';
    const TIMESTAMP_FIELD = 'TIMESTAMP NULL';
    const TINYINT_FIELD = 'TINYINT UNSIGNED NOT NULL';
